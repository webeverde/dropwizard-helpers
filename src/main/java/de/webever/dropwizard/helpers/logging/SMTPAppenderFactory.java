package de.webever.dropwizard.helpers.logging;
...
@JsonTypeName("smtp")
public class SMTPAppenderFactory extends AbstractAppenderFactory<ILoggingEvent> {
	...
	// only set the subject if its specified, since the SMTPAppender has a
	// sensible default
